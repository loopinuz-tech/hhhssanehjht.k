      ...
      <div className="flex items-center gap-2.5 flex-wrap">
        <div className="relative w-full sm:w-auto">
          ...
          <Input
            ...
            className="pl-9 h-9 w-full sm:w-[200px] bg-white dark:bg-[#080C14] border border-slate-200 dark:border-white/[0.06] rounded-lg text-[12px] font-bold placeholder:text-slate-400/50"
          />
        </div>
        {(activeTab === "wallet" || activeTab === "requests") && (
          <select
            className="h-9 px-3 flex-1 sm:flex-initial bg-white dark:bg-[#080C14] border border-slate-200 dark:border-white/[0.06] rounded-lg text-[12px] font-bold outline-none"
            value={statusFilter}
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Input
            ...
            className="h-9 flex-1 sm:w-[150px] bg-white dark:bg-[#080C14] border border-slate-200 dark:border-white/[0.06] rounded-lg text-[12px] font-bold"
            placeholder="Dan"
          />
          <Input
            type="date"
