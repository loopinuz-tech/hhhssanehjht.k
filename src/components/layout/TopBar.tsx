  ...
  const catalogColumns = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Sinflarim", path: "/myclass", icon: UsersGroupTwoRoundedIcon, desc: "O'quv markaz sinflari va topshiriqlar", badge: "Yangi" },
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {[
                      ...
                      { label: "Sinflarim", path: "/myclass", icon: UsersGroupTwoRoundedIcon },
