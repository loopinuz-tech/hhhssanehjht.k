...
import CenterPublicPage from "./pages/center/CenterPublicPage";
import CenterLayout from "./components/layout/CenterLayout";
import CenterDashboard from "./pages/center/CenterDashboard";
import CenterClasses from "./pages/center/CenterClasses";
import CenterClassDetails from "./pages/center/CenterClassDetails";
import CenterStudents from "./pages/center/CenterStudents";
import CenterMockTests from "./pages/center/CenterMockTests";
import CenterMockWizard from "./pages/center/CenterMockWizard";
import CenterResults from "./pages/center/CenterResults";
import CenterStaff from "./pages/center/CenterStaff";
import CenterTelegram from "./pages/center/CenterTelegram";
import CenterSubscription from "./pages/center/CenterSubscription";
import CenterSettings from "./pages/center/CenterSettings";
import MyClass from "./pages/MyClass";
import CenterExamSession from "./pages/center/CenterExamSession";
                ...
                <SubjectProvider>
                  <EduCoinProvider>
                    ...
                    <Routes>
                      ...
                      {/* B2B Education Center Public & Student Routes */}
                      <Route path="/c/:username" element={<CenterPublicPage />} />
                      <Route path="/myclass/test/:assignmentId" element={<RequireAuth><CenterExamSession /></RequireAuth>} />
                      ...
                      {/* Education Center Admin Portal */}
                      <Route path="/center" element={<RequireAuth><CenterLayout /></RequireAuth>}>
                        <Route index element={<CenterDashboard />} />
                        <Route path="classes" element={<CenterClasses />} />
                        <Route path="classes/:id" element={<CenterClassDetails />} />
                        <Route path="students" element={<CenterStudents />} />
                        <Route path="tests" element={<CenterMockTests />} />
                        <Route path="tests/create" element={<CenterMockWizard />} />
                        <Route path="tests/create/:id" element={<CenterMockWizard />} />
                        <Route path="tests/wizard" element={<CenterMockWizard />} />
                        <Route path="results" element={<CenterResults />} />
                        <Route path="results/:testId" element={<CenterResults />} />
                        <Route path="staff" element={<CenterStaff />} />
                        <Route path="telegram" element={<CenterTelegram />} />
                        <Route path="subscription" element={<CenterSubscription />} />
